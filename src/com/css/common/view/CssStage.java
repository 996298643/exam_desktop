...
public class CssStage extends Stage {
	...
	public void setView(Pane pane, double width, double height) {
		root.setCenter(pane);
	...
	public StackPane createTool(Stage stage) {
		...
		p.setId("top");
		HBox ltool = new HBox();
		ltool.setStyle("-fx-padding: 15px 15px 20px 20px;");
		...
		HBox rtool = new HBox();
		rtool.setStyle("-fx-padding: 15px 15px 20px 3px;");
